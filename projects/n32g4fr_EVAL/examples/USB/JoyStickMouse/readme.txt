...
3. 使用说明
    ...
    描述Demo的测试步骤和现象 
         1. 编译后下载程序复位运行；
         2. 通过 USB 线连接 J3 USB 口，挂在完成以后，按下 KEY1、KEY2、KEY3、KEY4(PA7接地)鼠标会上下左右移动。
...
3. Instructions for use
    ...
    Describe the test steps and phenomena of Demo 
        ...
        2. Connect the J3 USB port through a USB cable, after the mount is complete, press KEY1, KEY2, KEY3, KEY4(PA7 guounding), the mouse will move up and down, left and right.
